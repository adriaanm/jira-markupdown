...
h2. OS X + Sun 1.8.0_25 #1 - incorrect return value or crash
...
h2. Linux + OpenJDK 1.7.0_95 - passes
{code}
...
h2. Linux + OpenJDK 1.8.0_102 - passes
{code}
$ cat /etc/debian_version
8.5
...
h2. Linux + OpenJDK 1.7.0_111 - always crashes
{code}
