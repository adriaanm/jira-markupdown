...
{code}
Adriaan, while you're in there you might want to take a look at SI-1431 as well, which is crashing in the same spot for at least vaguely related reasons.
(In r22517) closes SI-3507: don't generate manifests where we can't refer to the existentially bound value
