This is something only a machine would generate, but anyway.
...
Oliver Ruebenacker adds that the stacktrace indicates that it is the typer that crashes. Can get the same error with
