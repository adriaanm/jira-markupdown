...
This issue seems similar to SI-4863 and SI-2034, but I'm raising it as a separate bug because the exception I'm seeing doesn't match the descriptions of those issues.
{noformat}
