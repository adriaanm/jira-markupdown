...
=== What versions of the following are you using? ===
  ...
  - Java:
  - Operating system: 
For the record, the patch for SI-4067 is not sufficient and the dimensions of the problem aren't 100% clear yet, so nothing is going to happen too imminently.
extempore:
...
It's been fixed, in HEAD. Nobody knows how, nobody knows when, some people think it was fixed in patch SI-4067, extempore says no. No elaboration. Just no, and forget about it.
