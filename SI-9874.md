...
I would guess that this and other floating point NumericRange tickets such as SI-8670, SI-8518, SI-9875, and so forth would need to be fixed together as part of a general overhaul to make this code more principled.
