...
symbol value $mr does not exist in scala.collection.slick.Test$delayedInit$body.apply
{noformat}
This will be resolved once macros allow untyped (i.e. non-typecheckable, i.e. non-macro-expandable) parameters. Stay tuned for progress on SI-5404.
For the record, the aforementioned crash was caused by an bug in the reifier: SI-5494.
