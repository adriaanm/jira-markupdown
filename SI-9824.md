...
Duplicate of https://issues.scala-lang.org/browse/SI-8119 ?
See also: https://issues.scala-lang.org/browse/SI-9076
the parallel collections example passes with {{-Yrepl-class-based}}, so that's a duplicate of SI-8119. 
[~moors] you put this in Backlog, but it's in the 2.12.0 release notes as a notable known bug...?
