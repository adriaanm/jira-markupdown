...
See also SI-7954, in which the @strictfp annotations is dropped on the floor as code is moved around in our encoding of traits and value classes.
...
_So be sure and do a clean compile if you apply this workaround._
