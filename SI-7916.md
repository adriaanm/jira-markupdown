...
re: the status of Scala's JSR 223 support, see https://issues.scala-lang.org/browse/SI-8422
...
thanks Maggie! it seems nearly certain the PR will be merged once [~apm] finds time to do a little more work on it.
