...
{code}
I closed SI-6530 on the grounds that Scala code should not ever refer to module class or inner classes with the $ syntax. So I'm going to do the same for this one.
