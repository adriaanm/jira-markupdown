...
It is worth noting that while this produces the same error as SI-975, it should be possible to fix this use of higher-kinded existentials without extending the type system or type inference algorithm.
merging with SI-2308, added test case there
