...
{code}
(In r22685) close SI-3667. all companion objects are now serializable. note that you can reproduce the error without default arguments:
...
review by extempore.
(In r22786) better fix for see SI-3667. not all objects are serializable, only companions of case classes or other serializable classes. review by polcinic.
