...
We should avoid calling into this sort of code in foundational parts of the standard library as the constructor for ControlThrowable. See SI-7814 for the an example of trouble this buys us.
