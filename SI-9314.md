...
scala> :quit
{code}
[~apm] I think I reported something similar in the past and as far as I remember you fixed the problem. You may want to have a look to this one too.
It progressed in SI-9127, but doesn't inspect the expression yet. For record, it would interpolate parens.
