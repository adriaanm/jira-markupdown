...
Having "ConcurrentHashMap" in Java I think "ConcurrentTrie" is a reasonable choice. Imho it is very dangerous to _not_ follow the standard naming without a very good reason, because it serves as precedent and excuse for users to ignore naming conventions in their own code.
