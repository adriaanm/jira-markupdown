...
I suspect that SI-7020 / https://github.com/scala/scala/commit/69557da5539a5a5132100fdab931e69f82139e15 might be to blame for a constant-factor increase in space usage.
Great!
...
error: java.lang.OutOfMemoryError: Java heap space
{noformat}
[~oxbow_lakes] Hey Chris, I'm going to reclose this, but I'd invite you to have another go at trying to reproduce this with the latest build and to open a new ticket if something is still broken or has regressed.
