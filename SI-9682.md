...
Note that this is independent of https://issues.scala-lang.org/browse/SI-9632 but they have a similar effect. But this one is far more serious as when the classloader is thrown away, the JVM seems to be unable to ever run the finalizers of the JarFiles.
