...
The stack trace is from 2.10.3, but it also fails in 2.11.0-RC1. The stack strace looks very similar to that of SI-8069.
...
This is not a valid execution context. We will update the documentation to explain that ECs must be async to be general purpose—i.e. you can only use the construct above to execute _your own_ code.
