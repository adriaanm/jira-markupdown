...
{code}
See also SI-5378, which I never got back to somehow. There are probably a whole bunch of variations on this available given the ad hoc manner in which it is recognized.
