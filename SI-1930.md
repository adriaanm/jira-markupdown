...
You should enclose an example that triggers this error, as self-contained and trimmed down as possible,  in order to allow us to diagnose the problem. In this case, this ticket looks like a duplicate of SI-1896.
"Is it possible to have a clearer message when this type of exception happens ?"
...
I would be very surprised if this was not a duplicate of SI-1896 which is fixed in r17719.
