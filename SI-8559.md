...
{code}
As with baseball stats, some must be discounted as assisted by various injections, such as Dr Odersky's run of Dummy Tickets (SI-77) or soc's meta-bug period.
...
I should receive partial credit on some of his. Look at SI-8338 for instance. I reopened it after it was closed not-a-bug, and it was again closed not-a-bug. That has to be reflected in my stats or the whole thing is a sham.
...
See also SI-2458 / https://github.com/retronym/scala/tree/ticket/2458, in which I have a fix for the arbiter of this rule. I'll add a task to that ticket to add a clarification to the spec along these lines.
