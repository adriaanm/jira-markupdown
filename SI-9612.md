Using annotation with default arguments sometimes causing a unnecessary warning. Order of parameters is same for usage and declaration so this is not caused by SI-7656. Tested on both 2.11.6 and 2.11.7.
