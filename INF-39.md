Since recently, in notification emails, trac sends only the path portion of the URL to the ticket, so you can't click on the link directly from your email.
