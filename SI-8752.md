...
[~retronym] thank you, I've already tweeted at [~burmako] about this problem. That's a good idea.
...
[~burmako] that's a great question. Having an unapply for TermName would be other thing but that's the only other request I can think of right now.
