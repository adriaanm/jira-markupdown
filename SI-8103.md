...
It looks like the specialized method of a trait is calling out directly into another specialized method which is not overriden, even though the generic versions is. I ran into that after running into a failure when trying to specialize my subclass (see SI-6265).
