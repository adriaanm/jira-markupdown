...
See also SI-3898, which also involves `@specialized` and overloading.

This is the next bug extracted from Scalala, following on from the recently fixed SI-4243. There's one more on the way. But after working around these two, it actually compiles, so there's light at the end of the tunnel.
...
Let's hope this fixes and closes SI-4257.
