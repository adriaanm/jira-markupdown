...
I expect such strictness to be detrimental instead of a feature for most applications. However, _failing_ and still returning something -- that does not represent the input given -- is definitely very bad.

For whatever it is worth, this reminds me a lot of SI-4520. Though the symptom is rather different, I suspect they both arise from the lack of an exception.
