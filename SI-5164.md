...
Compile this code:
```scala
scalac -P:continuations:enable TailRecContinuation.scala
```

I got:
```scala
error: java.lang.AssertionError: assertion failed: Trying to access the this of another class: tree.symbol = anonymous class TailRecContinuation$$anonfun$foo$1, ctx.clazz.symbol = class TailRecContinuation compilation unit:TailRecContinuation.scala
	...
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase.scala$tools$nsc$backend$icode$GenICode$ICodePhase$$genLoad(GenICode.scala:1006)
	...
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase.scala$tools$nsc$backend$icode$GenICode$ICodePhase$$genLoad(GenICode.scala:656)
...
Exception in thread "main" java.lang.AssertionError: assertion failed: Trying to access the this of another class: tree.symbol = anonymous class TailRecContinuation$$anonfun$foo$1, ctx.clazz.symbol = class TailRecContinuation compilation unit:TailRecContinuation.scala
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase.scala$tools$nsc$backend$icode$GenICode$ICodePhase$$genLoad(GenICode.scala:962)
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase.genLoadQualifier(GenICode.scala:1175)
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase.scala$tools$nsc$backend$icode$GenICode$ICodePhase$$genLoad(GenICode.scala:1006)
	at scala.tools.nsc.backend.icode.GenICode$ICodePhase$$anonfun$genLoadArguments$1.apply(GenICode.scala:1226)
