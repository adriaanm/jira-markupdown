...
Seeing as this wasn't actually fixed, SI-4949 is actually a duplicate of this, so the example there can serve as a more reduced case for this one,
...
{code}
Going to unfairly (in terms of which is the dup) close this as a duplicate of SI-5559.
