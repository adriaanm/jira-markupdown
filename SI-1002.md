...
BTW, please try again with tomorrow's nightly ... it's possible that today's fix for SI-1165 has had an effect.

Yes, Click.class takes place inside the bin dir.
SI-1165 was fixed (thanks!) in r15688, and I'm with r15690 already.
OK, thanks.
...
BTW, Miles, the issue takes place since time _before_ you have joined to the plugin development. So, it isn't "something new".
