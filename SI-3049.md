...
Band-aid for an obscure bit of fallout closes SI-3049.  No review.
...
this might be fsc breakage, like SI-4395. replace "scala" with "scala -nocompdaemon" and see if the problem goes away
