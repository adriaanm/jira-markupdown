...
(b) It would be good to be able to set it _before_ calling `start`, and outside the `act` method. I say this because you cannot be confident that code in the `act` method has executed unless you use some sort of synchronization (like sending/receiving a message).
