...
{noformat}
See also: SI-6723 SI-7393 SI-7685
...
Your conjecture that SI-6723 may be the root cause is plausible since exceeding inline counts could explain why a "global compile" fails when an "incremental compile" succeeds.
