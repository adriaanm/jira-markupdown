...
{code}
(In r23595) Adapt nested objects properly. I will need to refactor this handling of lazy vals at some point anyway because this pattern is repeated in I believe two or three places. see SI-3993 (although I am not entirely sure the two are related - more info to come in the ticket). review by dragos
...
Iulian, any comments? Also see SI-4034, where it seems that specialization is broken for resident compiler.
(In r23653) In r23627 Lukas fixed specialization bug that seemed to be the reason for SI-3993 and other specialization and resident compiler bugs. So reverting quick fix r23576 as it is not necessary anymore. No review. Closes SI-3993.
