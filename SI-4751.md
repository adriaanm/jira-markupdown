...
I am seeing this again and again in 2.10.3. I'm hoping that the fix to "substitution broken for dependent types", SI-7753, might help there.
Another request from SI-8515
...
{code}
This part seems SI-7051 in action again:
{code}
scala> val t2: c.T = ({c: C => new c.T {} })(c)
<console>:9: error: type mismatch;
 found   : $anon where type $anon <: c.T
