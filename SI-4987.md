...
See also duplicates SI-4645, SI-4685, SI-4707, SI-5058, especially my comment in SI-4645.  Consolidated under this one.
See also SI-5063, which is not exactly the same bug but should be considered when fixing this one.
