Under certain circumstances, queriying {{knownDirectSubclasses}} from a sealed trait from within a macro yields an empty list. It seems to be related to compilation order. Perhaps related to SI-7567, SI-7046.
