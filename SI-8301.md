...
one error found
{code}
Adriaan, I've just submitted https://issues.scala-lang.org/browse/SI-8304 with critical priority since it's a regression since 2.10.x. Don't know whether I should've marked it as a blocker.
