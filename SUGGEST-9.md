One of the uses for package private is to make sub-classing outside the package impossible (package private is not handled correctly right now, but the fix seems to be on the way, see Ticket SI-2568).
