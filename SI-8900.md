...
[~rytz] We're getting a false positive from `isDelambdafyFunction`. The symbol name in question is {{LambdaTests$$anonfun$org$kiama$example$lambda2$LambdaTests$$canons$1$1}}. I don't have a smaller reproduction yet.
