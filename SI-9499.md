...
I would argue that this is really the same bug (albeit from a different perspective) as SI-4776: had you been aware that the operation was a view, you might have had a better chance at reasoning that it would be stack-unsafe to chain a large number of transformations.
