With 2.8.0.r21826.  From the call to transpose in the stack trace, it might be related to SI-3397.  The fix for that doesn't help, though.  Speculating, it might be because transpose is being called on an irregular "matrix".
