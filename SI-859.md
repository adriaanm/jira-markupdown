...
This causes the Scala build to fail on F8 (previously mentioned as part of SI-290), and also on Mac OS X which has a similarly broken default Ant install.
