As noticed in the instability of the new test for SI-8549 under -Xcheckinit:
...
I assume you mean transient, not volatile. The confusion was probably caused by looking at my attempted fix for SI-7838 (where I made the same mistake) just before commenting on this ticket.
