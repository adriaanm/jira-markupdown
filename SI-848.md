...
FYI -- as i just noticed -- would not surprise me if this issue is related/equal to SI-765 (type check error) as the compile assertion stack trace looks similar --
