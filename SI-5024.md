The pattern matcher strips unused bindings, which is good, but this alters the behavior w.r.t SI-1503, which is not so good.  I need to record what bindings were stripped and type the RHS accordingly.
