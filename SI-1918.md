...
I don't think its a compiler problem. I think the plugin is not resolving the _eclipse_ classpath variable (ie, M2_REPO) before providing the jars to compiler.
