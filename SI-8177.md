...
{code}
I was able to fix this, and the code in my comment in SI-7753, without affecting either the original SI-7753 or SI-6161.
...
Note that one of the tests (from the comments of SI-7753) is stuck in pending-ville.
...
{code}
Moving Paul's test case from SI-7753 over here, as I closed that ticket as not-a-bug.
...
Just to add another angle: SI-6596 demonstrates that refinement owners aren't consistent in joint and separate compilation.
...
{code}
SI-764 opened by mark harrah in april 2008. Nice.
@adriaan If you're evolving coevolution, perhaps you'll wind up fixing, or enabling a fix of, SI-6493 / https://github.com/scala/scala/pull/2986
