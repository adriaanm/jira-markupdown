...
{code}
I discovered this ticket during the time when I try to fix SI-2634.
I have spend a couple of hours try to find why my solution which mentioned in SI-3265 didn't work. It confused my very much. I still don't know the reason, but I find something interested. 
...
{code}
While I expected to get fib(3) without any exception. I must have something missed. Is there any one to tell me why. I believe it is the key to fix SI-3273
...
this discussion is difficult to follow. Eastsun proposes a fix, but what bug does it fix? I'm not clear on why this is a separate ticket from SI-2634.
...
not his real name, but that's what we call him.  Closes SI-3273,
review by prokopec.
Is there anyone interested in SI-3526 ?
...
In case you're not on the list, see my comments at http://permalink.gmane.org/gmane.comp.lang.scala.internals/3890 .  (Further discussion at SI-3526 please.)
