...
[~sethtisue] that is something I could not do, but it seems very similar to SI-5366.
...
Edit: I only found that SI-5366 was related after I created this issue. I could not get it by the title.
[~apm] just updated the ticket. Take a look and see if it helps.
[~apm] I can say with lots of certainty that is the `name` . Since it happens in other usages of it, and I looked at it while debugging.
