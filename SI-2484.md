...
{code}
Fixed in r19655. The problem was that when re-trying an implicit search with an empty return type, some type info leaked out into TypeTrees. This caused the problems we saw here and in SI-2630.
