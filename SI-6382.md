...
{code}
It has nothing to do with string interpolation or implicits; it is a bug in delayedinit, and a duplicate of SI-5565.  Use a main method instead of "extends App" and it works.
