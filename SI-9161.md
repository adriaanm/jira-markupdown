...
Note that this is the same error as the one raised in SI-7790 which was supposedly fixed in Scala Compiler 2.10.4-RC1
...
Thanks again
I think you can just follow the instructions.  Cf SI-9159. As a last resort, or first resort, you'll get a wider audience on scala-user.
