...
According to _Programming in Scala_, this should produce 3, not 12. It looks like + is appending, not adding, although the result still winds up being an Int.
