...
{code}
Not sure if they are exact duplicates due to one being a primitive (SI-6108) and one being a user-defined value class (SI-6326, this bug).
Fixed by 7059d568fdcad4d5b510966fce5dbc573f1aa797

SI-6108 is fixed by the same commit. 

SI-5568 is independent; still persists.
