...
{code}
I see you fellows do not run with bleeding edge trunk.  I checked in a fix for this a couple days ago, this is a duplicate of SI-473 (which has a misleading title I should have changed.) It no longer compiles:
{code}
$$ scalac a.scala 
