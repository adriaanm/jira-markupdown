...
There are a number of existing tickets involving various combinations of pattern matching, existential, and bounds. Some of these tickets (e.g. SI-1786, SI-6169) have complicated histories. So, leaving this for Adriaan and/or Jason to decide whether this a duplicate or not.
...
Perhaps it's a clue.
at least vaguely related, hard to tell if underlying cause is same: SI-127 and SI-5195
