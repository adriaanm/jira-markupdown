...
two warnings found
{code}
We removed this option from -Xlint in SI-7712 because, as you have found, it is somewhat incomplete.
...
The PR tags the binds as if they were `(i @ _, j @ _) = t` which is the way to disable the warning in source.
