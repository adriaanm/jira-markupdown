This is similar to SI-3078 but the code that triggers the bug is different. If the class is not a case class then the test gets launched without any problems. BTW it doesn't make any difference if the case class is top level or inside another class/object.
...
(In r21072) Fixed SI-3078 and SI-3109.
