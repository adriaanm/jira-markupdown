...
I think the first part of the request dups SI-8265.
...
Yes I figured some of this would exist in other tickets. Well if it helps rest assured that SI-8265 will hit many projects. The convenience of invisible unsoundness has an accidental allure like few others.
...
I've lodged the ambiguity error as SI-8403. Looks like its a regression after my refactoring of Contexts.
