...
My current solution in such situations is to inspect the bytecode generated after each compilation, since this is the only way I know for sure that the compiler is doing _what I think_ it _should_ be doing. But, I rarely have to do this with Java, and I don't think I should have to do it with Scala to that extent.
