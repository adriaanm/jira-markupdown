The ScalaDoc is supposed to show the first sentence about a member as its summary. 2.11.2 fixed a bug where the first period found was treated as a sentence end (SI-8672). A similar bug still occurs with acronyms ending in a period, such as "i.e.".
