I found this while reducing SI-3896, but it's a different crash.
{code}
...
{code}
(extempore in [r25835|https://codereview.scala-lang.org/fisheye/changelog/scala-svn?cs=25835]) Test case closes SI-3898, no review.
