...
maybe SI-2945 is related... perhaps not.
see SI-3189 for an additional test case
on trunk:
{code}
scala>  0 match { case List(_*) => true }
...
Nothing that this cause SI-3530, but as I don't know which bug is worse I'm leaving it for now.
